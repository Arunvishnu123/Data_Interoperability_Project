...
package weather_forcast_Java_class;
...
public class WeatherApi {
    ...
    public String toString() {
        ...
        sb.append(WeatherApi.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("location");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WeatherApi) == false) {
            return false;
        }
        WeatherApi rhs = ((WeatherApi) other);
